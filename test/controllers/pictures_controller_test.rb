...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { data: @picture.data, name: @picture.name, type: @picture.type } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { data: @picture.data, name: @picture.name, type: @picture.type } }
